package com.prathanbomb.androidutilcode.sub.location;
...
import com.prathanbomb.subutil.util.LocationUtils;
    ...
    public void onCreate() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (isSuccess) ToastUtils.Companion.showShortSafe("init success");
                Looper.loop();
            }
        }).start();
    }

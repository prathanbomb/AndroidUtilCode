...
public final class SizeUtils {
    ...
    public static int dp2px(final float dpValue) {
        final float scale = Utils.Companion.getApp().getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(final float spValue) {
        final float fontScale = Utils.Companion.getApp().getResources().getDisplayMetrics().scaledDensity;

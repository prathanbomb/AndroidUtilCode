...
public final class ServiceUtils {
    ...
    public static Set getAllRunningService() {
        ActivityManager activityManager = (ActivityManager) Utils.Companion.getApp().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static void startService(final Class<?> cls) {
        Intent intent = new Intent(Utils.Companion.getApp(), cls);
        Utils.Companion.getApp().startService(intent);
    }
    ...
    public static boolean stopService(final Class<?> cls) {
        Intent intent = new Intent(Utils.Companion.getApp(), cls);
        return Utils.Companion.getApp().stopService(intent);
    }
    ...
    public static void bindService(final Class<?> cls, final ServiceConnection conn, final int flags) {
        Intent intent = new Intent(Utils.Companion.getApp(), cls);
        Utils.Companion.getApp().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(final ServiceConnection conn) {
        Utils.Companion.getApp().unbindService(conn);
    }
